...
for mem_limit in {10..2..2}; do
    ...
    echo "Log: $MICROBENCHMARK_HOME/results/spark_streaming/mem-limit-${mem_limit}.log"
    python -u producer_consumer_gpu.py --mem-limit $mem_limit --stage-level-scheduling > $MICROBENCHMARK_HOME/results/spark_streaming/mem-limit-${mem_limit}.log 2>&1
done
